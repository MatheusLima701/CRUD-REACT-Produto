...
export default function Produtos() {
    ...
    const editar = (e) => {
        ...
        produtoParaEditar.observacao = produtoParaEditar.observacao.substring(0, 10);
    ...
    const salvar = () => {
        if (!produto.dataCadastro || !produto.valor) {
            Swal.fire({
                icon: 'error',
                text: 'Quantidade  em Estoque </th>e Valor são obrigatórios.'
            });
